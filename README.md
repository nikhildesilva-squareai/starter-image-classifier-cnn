...
![Intermediate](https://img.shields.io/badge/difficulty-intermediate-F59E0B) ![Machine Learning](https://img.shields.io/badge/course-Machine%20Learning-0056CE) ![12 hours](https://img.shields.io/badge/estimated-12h-lightgrey)

> **Square 1 AI** starter template — Machine Learning

## Overview

In this intermediate-level project, you'll build a **Image Classifier (CNN)** using Python, PyTorch, CNN. Train a convolutional neural network to classify images with transfer learning. This is a hands-on project where you'll write real code, solve real problems, and build something you can showcase in your portfolio.
...
- Train and evaluate a neural network model with PyTorch
...
```bash
# Clone this template
git clone https://github.com/nikhildesilva-squareai/starter-image-classifier-cnn.git
cd starter-image-classifier-cnn
